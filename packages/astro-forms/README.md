...
- [How it works](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/how-it-works.md) — the full lifecycle walkthrough with screenshots: capture triggers, the server gate, admin views, analytics, recovery, payments, storage
- [Payments](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/payments.md) — Stripe/PayPal setup, the `/forms-pay` contract, fee caveats, webhook receiver recipes
- [Google Drive uploads](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/drive.md) — one-time consent, the 7-day token-expiry pitfall, the fallback contract
- [Lead recovery](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/recovery.md) — consent modes, per-form scoping, unsubscribe mechanics
- [Serverless](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/serverless.md) — Turso/libSQL storage, explicit secrets, cold-start-safe rate limiting
- [GDPR mechanics](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/gdpr.md) — each retention, erasure, and consent mechanic mapped to the GDPR concept it serves
...
Create a pay-link from any entry in the admin, or share `/forms-pay?amount=200` with no entry at all. The server recomputes every total, and payments are marked paid only by verified Stripe or PayPal webhooks ([payments docs](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/payments.md)).
...
Uploads land in your own Google Drive over raw REST (no SDK dependency). If Drive fails, files up to ~10MB fall back to email attachment; larger files are flagged and the entry still saves ([Drive docs](https://github.com/nipun-arora/cool-astro-forms/blob/main/docs/drive.md)).
